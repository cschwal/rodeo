...
input_fitting_file = 'fitting_set.csv'          # the CSV containing the data to be fitted
output_filename = 'fitting_results.csv'     # output filename; this will be a CSV with the first column being the primary key and the second being the classification
